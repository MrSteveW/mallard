...
Mallard is a staff management system. Admin are able to add more users. Admin are able to define a repeating shift pattern for each user. Shifts may be any length of time and may go overnight. The app uses Git for version control. The app is hosted/deployed on Laravel Cloud with a PostgreSQL database.

## Domain glossary

- User is any person using the Mallard app
- ShiftPattern is a template of a repeating pattern of future Duties
- ShiftPattern records record the user_id, sequential day count, the shift_type, start_time and end_time
- All staff will follow an identical number of days in the ShiftPattern template.
